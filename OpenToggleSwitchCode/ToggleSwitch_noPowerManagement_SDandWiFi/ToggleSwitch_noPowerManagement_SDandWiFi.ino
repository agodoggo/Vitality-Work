...
const char* OOCSIName = "Vitality@Work/toggleSwitch1";
...
void OOCSI_sendMessageOpen(){
  oocsi.newMessage("Vitality@Work/toggleSwitch1/TimeStampData");
//  String TimeStampString;
//  TimeStampString += TimeStampBuf;
  oocsi.addString("device_id","dad4db3cedad1484b");
  oocsi.addString("open",TimeStampBuf);
  oocsi.sendMessage();
  oocsi.printSendMessage();
  oocsi.check();
}

void OOCSI_sendMessageClose(){
  oocsi.newMessage("Vitality@Work/toggleSwitch1/TimeStampData");
//  String TimeStampString;
//  TimeStampString += TimeStampBuf;
  oocsi.addString("device_id","dad4db3cedad1484b");
  oocsi.addString("close",TimeStampBuf);
  oocsi.sendMessage();
  oocsi.printSendMessage();
  oocsi.check();
}
...
//  oocsi.setActivityLEDPin(LED_BUILTIN);
  ...
  oocsi.subscribe("Vitality@Work/toggleSwitch1");
