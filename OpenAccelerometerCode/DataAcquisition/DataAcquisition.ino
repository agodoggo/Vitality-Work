...
void setup(void) 
{
  ...
  acccel.setActivityXYZ(1,1,1); // Set to activate movement detection in the axes "adxl.setActivityXYZ(X, Y, Z);" (1 == ON, 0 == OFF)
  ...
  //The ADXL345 will generate its interrupts on the Wemos D1 pin D3
