...
const char* OOCSIName = "Vitality@Work/Accelerometer1";
const char* hostserver = "oocsi.id.tue.nl";
OOCSI oocsi = OOCSI();

//#define ADXL_INT1 D3 // interrupt pin defined // unused in this code version
...
//  oocsi.addString("timestamp",TimeStampBuf);
  oocsi.addFloat("accX",averageAccel[0]);
  oocsi.addFloat("accY",averageAccel[1]);
  oocsi.addFloat("accZ",averageAccel[2]);
  oocsi.sendMessage();
  oocsi.printSendMessage();
  oocsi.check();
  memset(averageAccel,0,sizeof(averageAccel));
}
...
//    Serial.println("Measurement above threshold");
